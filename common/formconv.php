...
if ($vars=="")
...
else
  {
    ...
    $d=$_REQUEST["d"];
    $vars=$_REQUEST["vars"];
    if ($vars=="dx dy") {$vars="\\textrm{d}x\\, \\textrm{d}y";}
    elseif ($vars=="dy dx") {$vars="\\textrm{d}y\\, \\textrm{d}x";}
    elseif ($vars=="r dr dphi") {$vars="r\\;\\textrm{d}r\\, \\textrm{d}\\varphi";}
    elseif ($vars=="r dphi dr") {$vars="r\\;\\textrm{d}\\varphi\\, \\textrm{d}r";}
    echo __("Formula");
