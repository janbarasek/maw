...
if ($what=="")
{
  if ($_REQUEST["output"]=="html") {$what="";} else {$what="pdf";}
}
...
function my_number_format($var)
{
 ...
 if (abs($temp)<0.001) 
   ...
   else {return (round(100000*$temp)/100000);}
}
...
function def_tex($string,$def) {return("\\def".$string."{".$def."}\n\n");}
...
if ($method=="bisection"){$formula="\\frac{a+b}2";}
else {$formula="\\frac{af(b)-bf(a)}{f(b)-f(a)}";}
