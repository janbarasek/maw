...
if ($funkce == "") {$akce=0; $funkce=rawurldecode($_SERVER['QUERY_STRING']);}
if (stristr($funkce,"tlacitko")){$funkce="";}
...
function fixderivative($str) {global $formconv_repl_input,$formconv_repl_output, $akce;

$arrsearch=Array("\"\\\\krok", "\"\\\\uprava", "\"\\\\constantrule", "\"\\\\constantmultrule", "\"\\\\construle", "\"\\\\productrule", "\"\\\\quotientrule", "\"\\\\powerrulex", "\"\\\\powerrule", "\"\\\\sinrule", "\"\\\\cosrule", "\"\\\\tanrule", "\"\\\\cotrule", "\"\\\\sinhrule", "\"\\\\coshrule", "\"\\\\tanhrule", "\"\\\\cothrule", "\"\\\\arcsinrule", "\"\\\\arccosrule", "\"\\\\arctanrule", "\"\\\\arccotrule", "\"\\\\arcsinhrule", "\"\\\\arccoshrule", "\"\\\\arctanhrule", "\"\\\\arccothrule", "\"\\\\exprule", "\"\\\\genexprule", "\"\\\\logrule", "\"\\\\genlogrule", "\"\\\\linearity", "\"\\\\expvarexprule", "\"\\\\absrule", "\"\\\\secrule", "\"\\\\cscrule" );

$arrreplace=Array(" ",__("Simplification"),__("Constant rule"),__("Constant multiple rule"),__("Constant rule"),__("Product rule"),__("Quotient rule"),sprintf(__("Derivative of %s"),"\$ x\$"),__("Derivative of power function"),__("Derivative of sine function"),__("Derivative of cosine function"),__("Derivative of tangent function"),__("Derivative of contangent function"),__("Derivative of hyperbolic sine function"),__("Derivative of hyperbolic cosine function"),__("Derivative of hyperbolic tangent function"),__("Derivative of hyperbolic contangent function"),__("Derivative of arcsine function"),__("Derivative of arccosine function"),__("Derivative of arctan function"),__("Derivative of acrcotan function"),__("Derivative of hyperbolic arcsine function"),__("Derivative of hyperbolic arccosine function"),__("Derivative of hyperbolic arctan function"),__("Derivative of hyperbolic acrcotan function"),__("Derivative of exponential function"),__("Derivative of exponential function"),__("Derivative of logarithm"),__("Derivative of logarithm"),__("Sum rule"),__("Conversion into exponential function"),__("Derivative of absolute value"),__("Derivative of sec function"),__("Derivative of csc function"));

$arrreplace2=array_map(function($val) { return $val.": \\\\("; }, $arrreplace);
$arrreplace2[0]="\\\\(";

$str=str_replace("\\\\konec","\\\\)",$str);
if ($akce==1)
{
 $arrsearchB=Array("\"\\\\krok {y}^\\\\prime", "\"\\\\uprava {y}^\\\\prime", "\"\\\\zadani y=");
 $arrreplaceB=Array("\\\\(\\\\frac{\\\\partial z}{\\\\partial x}", __("Simplification").": \\\\(\\\\frac{\\\\partial z}{\\\\partial x}", " z=");
 $str=str_replace($arrsearchB,$arrreplaceB,$str);
 }
if ($akce==2)
{
 $arrsearchB=Array("\"\\\\krok {y}^\\\\prime", "\"\\\\uprava {y}^\\\\prime", "\"\\\\zadani y=");
 $arrreplaceB=Array("\\\\(\\\\frac{\\\\partial z}{\\\\partial y}", __("Simplification").": \\\\(\\\\frac{\\\\partial z}{\\\\partial y}", " z=");
 $str=str_replace($arrsearchB,$arrreplaceB,$str);
 }
...
if (substr($value,0,2)=="\\(") { echo "<br>$value </div><div class=logickyBlok>\n"; } else {echo "\n<li>$value";}
}
