...
if ($akce=="1")
{
  ...
  if (($podmnez=="on")) {$fcef=$fcef."+1.231456*(sqrt(x))+1.4217681*sqrt(y)";}
...
else
  {
    ...
    if ($axislabels=="on"){fwrite($soubor, "unset border\n unset ytics\n unset xtics\nset zeroaxis lt -1\nset tics axis\n unset ztics\n set ytics offset graph 0-0.11,0\n");}
...
if ($pocet_nerovnic>1)
  {
	...
	if ($rozd_nerovnice[$i]!="")
	  {
	    if ($allinequalitites!="") {$allinequalitites=$allinequalitites."\\\\";}
