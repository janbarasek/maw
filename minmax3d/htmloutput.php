...
if ($akce=="2")
{
printf ("<h4>%s:</h4>",__("Tested stationary points")); echo (str_replace(Array("\\fboxrule 0pt","\boxed"),"",$body));
}
...
<center>
<table>
<tr><th></th><th><?php echo (str_replace("&","</th><th>",$bodytab)); ?></th></tr>
<tr><th>$f''_{xx}$</th><td><?php echo (str_replace("&","</td><td>",$fxxtab)); ?></td></tr>
<tr><th>$f''_{xy}$</th><td><?php echo (str_replace("&","</td><td>",$fxytab)); ?></td></tr>
<tr><th>$f''_{yy}$</th><td><?php echo (str_replace("&","</td><td>",$fyytab)); ?></td></tr>
<tr><th><?php echo __("Hessian"); ?></th><td><?php echo (str_replace("&","</td><td>",$Htab)); ?></td></tr>
<tr><th><?php echo __("Conclusion"); ?></th><td class=bold><?php echo (str_replace("&","</td><td class=bold>",$concltab)); ?></td></tr>
</table>
</center>
</div>
