...
$x=input_to_maxima($x); 
$y=input_to_maxima($y);
if ($z=="") {$dimension=2;} else {$dimension=3;}
if ($dimension==3) {$z=input_to_maxima($z);}
...
if ($kind=="2") 
  {
    ...
    if ($dimension=="3") {$fz=input_to_maxima($fz);}
  } 
else
  {
...
if ($kind=="1")
  {
    ...
    $keywords=array("fx","x","y","z","dx","dy","dz","ds","tmin","tmax","integrand","primitive","result","ok","integrand-math","Fa","Fb");
  }
else
  {
    if ($dimension==2) { $fz=0; $z=0; }
    ...
    $output=`$mawtimeout $maxima2 --batch-string="$command"`;
    $keywords=array("fx", "fy", "fz", "x","y","z","dx","dy","dz","tmin","tmax","integrand","primitive","result","ok","integrand-math","Fa","Fb");
  }
