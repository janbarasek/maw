...
if ( ($f2 != "")){$funkce=$funkce." linewidth 3,".math_to_GNUplot($f2); }
if ( ($f3 != "")){$funkce=$funkce." linewidth 3,".math_to_GNUplot($f3); }
if ( ($f4 != "")){$funkce=$funkce." linewidth 3,".math_to_GNUplot($f4); }
if ( ($f5 != "")){$funkce=$funkce." linewidth 3,".math_to_GNUplot($f5); }
...
if ($border=="") {fwrite($souborobr,"set noborder \n");}
if ($out=="png")
{
