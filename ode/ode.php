...
if ($akce == "0") {
	$rovniceinput2 = "y'=" . $rovniceinput2;
} else {
	$rovniceinput2 = $_REQUEST["ode2"];
}
...
if ($akce == "0") {
	$rovniceinput2 = "y'=" . $rovnice;
}
if (!(stristr($rovniceinput2, "="))) {
	$rovniceinput2 = $rovniceinput2 . "=0";
}
...
$subfrom = ["!!ODEproblem", "!!ODEsolution", "!!ODEfootnoteA", "!!ODEfootnoteB", "!!ODEkonstresHOM", "!!ODEkonstres", "!!ODEnotfound", "!!ODEseparace", "!!ODEnekres", "!!ODEobres", "!!ODEpartres", "!!ODEvarconst", "!!ODErovnicejelinearni", "!!ODErovnicejehomogenni", "!!ODEassochomrce", "!!ODEhomogeneousequation", "!!ODEsingular_solution", "!!ODEsubstitution", "!!ODEunknownsolved", "!!ODEintfactormsg", "!!Variacekonstant", "!!Integracnifaktor", "!!Vypocetintegracnihofaktoru", "!!Resenipomociintegracnihofaktoru"];

$subto = [__("Problem"), __("Solution"), __("The computation could be divided into more pages"), __("Not all brackets which are written by the computer are necessary. Many of them can be safely omitted."), __("Linear solution"), __("Constant solution"), "\\text{}\$" . __("Not found.") . "\${}", __("Separation of variables"), __("Nonconstant solution"), __("General solution"), __("Particular solution"), __("Variation of constant:"), __("Equation is linear"), __("Equation is homogeneous  -- we will use separation of variables and write the solution in explicit form."), __("Associated homogeneous equation"), __("Homogeneous equation"), __("Singular solution"), __("substitution"), __("The equation has been solved, but it is neither linear nor separable, homogeneous or exact and no intermediate steps are shown. The equation is #1."), __("The equation has integrating factor #1."), __("Method 1 (variation of constant)"), __("Method 2 (Integrating factor)"), __("Evaluating integrating factor"), __("Integration using integrating factor")];
